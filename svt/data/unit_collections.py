...
class SI(Unit.Collection):
    ...
    def m(prefix=""):
        return Unit(
            ...
            dimension=Unit.Dimension(["length"]),
    ...
    def Hz(prefix=""):
        return Unit(
            ...
            dimension=Unit.Dimension([], ["time"]),
            prefix=Unit.Prefix(prefix),
            alternate_symbol=Unit.Symbol(["Hz"]),
        )
    ...
    def K():
        return Unit(
            symbol=Unit.Symbol(["K"]),
            dimension=Unit.Dimension(["temperature"]),
            prefix=Unit.Prefix(""),
        )
    ...
    def A(prefix=""):
        return Unit(
            symbol=Unit.Symbol(["A"]),
            dimension=Unit.Dimension(["current"]),
            prefix=Unit.Prefix(prefix),
        )
    ...
    def mol():
        return Unit(
            symbol=Unit.Symbol(["mol"]),
            dimension=Unit.Dimension(["amount"]),
            prefix=Unit.Prefix(""),
        )
    ...
    def cd():
        return Unit(
            symbol=Unit.Symbol(["cd"]),
            dimension=Unit.Dimension(["luminousity"]),
            prefix=Unit.Prefix(""),
        )
    ...
    def C(prefix=""):
        return Unit(
            symbol=Unit.Symbol(["A", "s"]),
            dimension=Unit.Dimension(["current", "time"]),
            prefix=Unit.Prefix(prefix),
            alternate_symbol=Unit.Symbol(["C"]),
        )

    @staticmethod
    def V(prefix=""):
        return Unit(
            symbol=Unit.Symbol(["g", "m", "m"], ["s", "s", "s", "A"]),
            dimension=Unit.Dimension(
                ["mass", "length", "length"], 3 * ["time"] + ["current"]
            ),
